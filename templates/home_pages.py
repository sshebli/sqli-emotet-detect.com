...
def render_home_about_sections() -> None:
    ...
    with col1:
        with st.container(border=True, key="about_abstract_box", height=330):
    ...
    with col2:
        with st.container(border=True, key="about_overview_box", height=330):
    ...
    with col3:
        with st.container(border=True, key="about_objective_box", height=330):
    ...
    with col4:
        with st.container(border=True, key="about_problem_box", height=330):
